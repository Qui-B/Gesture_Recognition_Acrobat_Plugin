...
ACCB1 ASBool ACCB2 PluginInit(void)
{
	...
	AVAppRegisterNotification(AVDocDidOpenNSEL,gExtensionID,
		(void*)ASCallbackCreateNotification(AVDocDidOpen, DocOpenedCallback), NULL);

	AVAppRegisterNotification(AVDocWillCloseNSEL, gExtensionID,
		(void*)ASCallbackCreateNotification(AVDocWillClose, DocWillCloseCallback), NULL);
